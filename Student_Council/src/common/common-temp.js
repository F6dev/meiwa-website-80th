...
//   const container = document.getElementById("main-centered");
...
//     // コンテナ内での相対位置に応じて固定
//     const top = Math.max(100, scrollY - containerTop + 300);
//     sidebar.style.top = `${top}px`;
//   });
// });

// https://qiita.com/miwashutaro0611/items/bc4cf66bef3a825ace1c#title%E3%82%BF%E3%82%B0%E4%BB%A5%E5%A4%96%E3%81%AEmeta%E3%82%BF%E3%82%B0%E3%81%AE%E6%83%85%E5%A0%B1%E3%81%AE%E6%9B%B8%E3%81%8D%E6%8F%9B%E3%81%88%E3%82%92%E8%A1%8C%E3%81%86
  ...
  connectedCallback() {
    this.innerHTML = `
      ...
      <header id="common-header">
        <a class="logo" href="/Student_Council/">
          <img src="/Student_Council/src/images/meiwa-logo.svg" alt="Site logo">
        </a>
        <div class="nav-actions">
          <nav>
            ...
            <a href="#" class="link-collection-trigger">その他</a>
          ...
          <div class="icon menu-toggle">
            <img src="/Student_Council/src/images/menu.png" alt="Menu" class="mobile-only">
          </div>
        </div>
      </header>
  ...
  connectedCallback() {
    ...
    <footer>
      <div class="footer-wave">
        <img src="/Student_Council/src/images/footer-wave.png" alt="">
      </div>
      <div class="footer-content">
        <div class="footer-main">
          <a class="logo-wrapper" href="/Student_Council/index.html">
            <img src="/Student_Council/src/images/footer-logo.svg" alt="Site logo" class="footer-logo">
          </a>
        ...
        <div class="footer-links">
          ...
          <a href="/School_Festival2025/App/">明和祭2025 公式アプリ</a>
          <a href="https://guest.meiwa.website/">明和祭2025 学校説明会予約システム</a>
          <a href="https://meiwa-h.aichi-c.ed.jp/cms/">明和高等学校公式ウェブサイト</a>
