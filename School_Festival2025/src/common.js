...
function observeHeaderInsertion() {
  ...
  observer.observe(document.body, {
    childList: true,
    subtree: true, // 子孫すべてを監視
  });

  // タイムアウトで監視をやめる（例：10秒経過後）
  setTimeout(() => {
    observer.disconnect();
    console.warn("#common-header was not found within 10 seconds.");
  }, 10000);
}

function setupHeaderScrollEffect(header) {
  const getDefaultOpacity = () => (window.innerWidth > 940 ? "1" : "0.4");

  // 常に表示（flex）にしておく。初期透明度はスクロール位置によって後で設定
  header.style.display = "flex";
  header.style.opacity = window.scrollY > 0 ? "1" : "0.4"; // 初期状態設定

  window.addEventListener("scroll", function () {
    const scrollTop = window.scrollY || window.pageYOffset;

    // トランジションを毎回設定（必要なら一度だけでも可）
    header.style.transition = "opacity 0.5s ease";

    if (scrollTop === 0) {
      header.style.opacity = "0.4";
    } else {
      header.style.opacity = "1"; // スクロール中は完全不透明
    }
  });
}

// DOM準備完了後に監視開始
if (location.pathname == "/School_Festival2025/") {
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", observeHeaderInsertion);
  } else {
    observeHeaderInsertion();
  }
}
  ...
  connectedCallback() {
    this.innerHTML = `
      <style>
        ...
        @media (min-width: 741px) and (max-width: 1010px) {
          .icon {
            width: 2rem;
            height: 2rem;
          }
      ...
      <header id="common-header">
        <a class="logo" href="/School_Festival2025/">
          <img src="/School_Festival2025/src/img/aikon.png" alt="明和祭2025 アイコン">
        </a>
        <div class="nav-actions">
          <nav>
            <a href="/School_Festival2025/Timetable">タイムテーブル</a>
            <a href="/School_Festival2025/HR_Event">HR企画</a>
            <a href="/School_Festival2025/Drama_Event">劇企画</a>
            <a href="/School_Festival2025/Sympathizers_Event">有志企画</a>
            <a href="/School_Festival2025/School_Introduction">学校説明会</a>
            <a href="/School_Festival2025/Vote/Result">結果</a>
            <a href="/School_Festival2025/Survey">アンケート</a>
            <a href="/School_Festival2025/QandA">Q&A</a>
          ...
          <div class="icon menu-toggle">
            <img src="/School_Festival2025/src/img/menu.png" alt="Menu" class="mobile-only">
          </div>
        </div>
      </header>
    ...
    <footer>
      ...
      <div class="footer-content">
        <div class="footer-main">
          <a class="logo-wrapper" href="/School_Festival2025/">
            <img src="/School_Festival2025/src/img/aikon.png" alt="明和祭2025 企画アイコン" class="footer-logo">
          </a>
          <h2>愛知県立明和高等学校生徒会<br>TEL:052-961-2551<br>FAX:052-953-6348<br>〒461-0011 名古屋市東区白壁二丁目32番6号</h2>
        </div>
        <div class="footer-links">
         <a href="https://guest.meiwa.website/" target="_blank">明和祭2025 学校説明会予約ページ</a>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const headerNavItems = [
    { text: "トップページ", href: "/School_Festival2025/" },
    { text: "タイムテーブル", href: "/School_Festival2025/Timetable" },
    { text: "HR企画", href: "/School_Festival2025/HR_Event/" },
    { text: "劇企画", href: "/School_Festival2025/Drama_Event/" },
    { text: "有志企画", href: "/School_Festival2025/Sympathizers_Event/" },
    { text: "学校説明会", href: "/School_Festival2025/School_Introduction/" },
    { text: "結果", href: "/School_Festival2025/Vote/Result/" },
    { text: "アンケート", href: "/School_Festival2025/Survey/" },
    { text: "Q&A", href: "/School_Festival2025/QandA/" },
  ];

  // <a href="/School_Festival2025/Sports_Festival">体育祭</a>
  //           <a href="/School_Festival2025/HR_Event">HR企画</a>
  //           <a href="/School_Festival2025/Drama_Event">劇企画</a>
  //           <a href="/School_Festival2025/Sympathizers_Event">有志企画</a>
  //           <a href="/School_Festival2025/School_Introduction">学校説明会</a>
  //           <a href="/School_Festival2025/Result">結果</a>
  //           <a href="/School_Festival2025/Survey">アンケート</a>
  //           <a href="/School_Festival2025/QandA">Q&A</a>
  ...
  function renderMobileMenu() {
    ...
    headerNavItems.forEach((item, idx) => {
      ...
      img.src = `/School_Festival2025/src/img/arrow/${iconName}.svg`;
      img.alt = "arrow";
...
function openModal(id) {
  ...
  console.log(modalWrapperDiv.scrollTop);
  modalWrapperDiv.scrollTop = 0;
  modalWrapperDiv.scrollLeft = 0;
...
function openSDrawer() {
  // console.log("伝搬してる?!")
  // 25vw見えます
  // document.getElementById("tl-sd").style.top = "75vw"
  // document.getElementById("tl-sd-title").textContent = element.name;
  // document.getElementById("tl-sd-description-short").innerHTML =
  //     element.shortDescription.replace(/\n/g, "<br>");
  // document.getElementById("tl-sd-description-long").innerHTML =
  //     element.longDescription.replace(/\n/g, "<br>");
  const swipeDrawer = document.getElementById("tl-sd");
  // const swipeDrawerBG = document.getElementById("tl-sd-bg");
  swipeDrawer.classList.add("enable-top-transition");
  // swipeDrawerBG.style.display = "block";
  setTimeout(() => {
    swipeDrawer.style.top = "75dvh";
    // swipeDrawerBG.style.opacity = "0.3";
  }, 50);
  setTimeout(() => {
    swipeDrawer.classList.remove("enable-top-transition");
  }, 700);
}

function closeSDrawer() {
  const swipeDrawer = document.getElementById("tl-sd");
  swipeDrawer.style.top = "100dvh";
  const swipeDrawerBG = document.getElementById("tl-sd-bg");
  swipeDrawerBG.style.opacity = "0";
}

function snapDrawer() {
  const swipeDrawer = document.getElementById("tl-sd");
  const sDTop = parseInt(swipeDrawer.style.top, 10);
  // ばりばりAI
  // これは上からの高さの割合です
  const arr = [15, 55, 88, 96];
  const closestValue = arr.reduce((prev, curr) => {
    return Math.abs(curr - sDTop) < Math.abs(prev - sDTop) ? curr : prev;
  });
  console.log("スナップします", closestValue);
  swipeDrawer.classList.add("enable-top-transition");
  swipeDrawer.style.top = `${closestValue}dvh`;
  let cVO = 1;
  switch (closestValue) {
    case 96:
      cVO = 0.1;
  ...
  document.getElementById("tl-sd").style.opacity = cVO;
  setTimeout(() => {
    swipeDrawer.classList.remove("enable-top-transition");
  }, 700);
}
...
// document.addEventListener("DOMContentLoaded", function () {
//   console.log("[newmodal.js] function開始～");

//   // まんまAIのコピペ

//   const draggable = document.getElementById("tl-sd-draggable");
...
//     // ドラッグ開始位置を記録（マウスまたはタッチイベントに対応）
//     dragStartX = e.pageX || e.touches[0].pageX - draggable.offsetLeft;
//     dragStartY = e.pageY || e.touches[0].pageY - draggable.offsetTop;
//   };
...
//       const cursorY = (e.clientY || e.touches[0].clientY) - 12; // カーソルのY座標を取得
//       const cursorYInVh = (cursorY / viewportHeight) * 100; // Y座標をvhに変換

//       const decreaseFactor = 0.4; // カーソル位置の減少具合を調整する変数
//       let limitedCursorYInVh;

//       // Y座標の上限を設定し、必要に応じて調整
//       if (cursorYInVh < 15) {
//         limitedCursorYInVh = 15 - (15 - cursorYInVh) * decreaseFactor;
//       } else {
//         limitedCursorYInVh = Math.max(cursorYInVh, 15); // 15vh以上はそのまま
//       }

//       // カーソルの位置に向かって変化させる処理
//       if (limitedCursorYInVh < cursorYInVh) {
//         limitedCursorYInVh +=
//           (cursorYInVh - limitedCursorYInVh) * decreaseFactor;
//       }

//       // 最終的なY座標を設定
//       if (limitedCursorYInVh < cursorYInVh) {
//         limitedCursorYInVh = Math.min(
//           limitedCursorYInVh +
//             (cursorYInVh - limitedCursorYInVh) * decreaseFactor,
//           cursorYInVh
//         );
...
//       // トランジションを無効にして位置を更新
//       document
//         .getElementById("tl-sd")
//         .classList.remove("enable-top-transition");

//       // console.log("カーソルの位置:", limitedCursorYInVh.toFixed(2) + "dvh"); // カーソル位置をログに表示
//       document.getElementById("tl-sd").style.top =
//         limitedCursorYInVh.toFixed(2) + "dvh"; // 要素のY座標を更新
//       // document.getElementById("tl-sd").style.opacity = 1 - limitedCursorYInVh / 100;
//       document.getElementById("tl-sd").style.opacity = 0.6;
//     }
//   };
...
//     if (isDragging) {
//       isDragging = false;
//       snapDrawer(); // スナップ機能を追加
//     }
//   };

//   // イベントリスナーの設定
//   draggable.addEventListener("mousedown", startDrag); // マウスによるドラッグ開始
//   draggable.addEventListener("touchstart", startDrag); // タッチによるドラッグ開始

//   document.addEventListener("mousemove", dragMove); // マウス移動時のドラッグ処理
//   document.addEventListener("touchmove", dragMove); // タッチ移動時のドラッグ処理

//   document.addEventListener("mouseup", endDrag); // マウスアップ時のドラッグ終了
//   document.addEventListener("touchend", endDrag); // タッチ終了時のドラッグ終了

//   window.addEventListener("mouseleave", endDrag); // ウィンドウからマウスが離れたときの処理
// });
